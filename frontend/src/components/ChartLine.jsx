        ...
        async function fetchFormData() {
            try {
                ...
                const response = await fetch(
                    API_ENDPOINTS.getThresholdSensors(cmtk, port)
                );
                ...
                // Set values
                setMaxTemp(jsonData.data.tempMax);
                setMaxVib(jsonData.data.vibMax);
        ...
        >
            <Plot
                ...
                layout={{
                    ...
                    xaxis: {
                        showticklabels:
                            typeof showAxis === "boolean" ? showAxis : false,
                    },
                    shapes: [
                        {
                            type: "line",
                            ...
                            y0:
                                chartTitle ===
                                "Historial Contact Temperature Contact Temperature [°C]"
                                    ? warningTemp
                                    : warningVib,
                            y1:
                                chartTitle ===
