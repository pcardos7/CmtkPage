...
const API_ENDPOINTS = {
     ...
     */
    getData: (location, cmtk) =>
        `${BACKEND_IP}/api/get-data/${location}/${cmtk}`,
     ...
     */
    getSensorData: (location, port) =>
        `${BACKEND_IP}/api/get-sensor-data/${location}/${port}`,
     ...
     * @returns
     */
    getReadData: (cmtk, time, port) =>
        `${BACKEND_IP}/api/get-data/${cmtk}?time=${time}&port=${encodeURIComponent(
            port
        )}`,
     ...
     * @param {string} port
     */
    getPortHealth: (cmtk, port) =>
        `${BACKEND_IP}/api/get-health/${cmtk}?port=${encodeURIComponent(port)}`,
     ...
     * @param {string} port
     */
    getThresholdSensors: (cmtk, port) =>
        `${BACKEND_IP}/api/get-threshold-sensors/${cmtk}/${port}`,
